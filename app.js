...
// 選擇seclect內部的OPTION之後，要改變相對應的顏色
...
let addButton = document.querySelector(".plus-btn"); //static Nodelist
...
function handleSorting(direction) {
  ...
  // select可直接用JS去更改
  // document.querySelector是static的nodeList因此要再抓一次nodeList
